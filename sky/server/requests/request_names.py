...
class RequestName(str, enum.Enum):
    ...
    REALTIME_LSF_GPU_AVAILABILITY = 'realtime_lsf_gpu_availability'
    LSF_NODE_INFO = 'lsf_node_info'
    LSF_QUEUE_INFO = 'lsf_queue_info'
    LSF_CLUSTER_NAMES = 'lsf_cluster_names'
    ...
    REQUEST_DAEMON_LAUNCH_METRICS = 'launch-metrics'
